      ...
      <div className="flex w-screen min-h-screen flex-col items-center justify-center relative bg-primary pb-20">
        <nav className="w-full px-6 z-50  fixed inset-x-0 top-2 flex justify-center items-center ">
          <div className=" w-full md:w-880 bg-navBar p-4 rounded-2xl flex items-center">
            <p className="text-lg text-slate-200 font-medium">Narayan</p>
        ...
        <main className="w-[80%] mt-4">
          ...
          >
            <div className="w-full h-420 flex items-center justify-center">
              <div className="w-275 h-340 relative bg-zinc-900 rounded-md hover:bg-zinc-800">
                <img
                  src={Face}
                  alt=""
            ...
            <div className="w-full h-420 flex flex-col items-center justify-center ">
              <div className="w-full h-auto flex flex-col items-start justify-start ml-12">
                <span className="text-2xl font-bold text-textBase relative tracking-widest p-2">
                  {" "}
                  Hello
                  <span className="w-12 h-1 absolute content-none bottom-3 bg-gradient-to-br from-green-400 to-blue-600 mx-2 mt-1">
                    {" "}
                  </span>
                </span>
                <h1 className="text-5xl text-textBase font-black tracking-wider">
                  {" "}
                  I'm{" "}
                  <span ref={element} className="text-blue-500">
                    {" "}
                  </span>
                </h1>
              </div>
              ...
              >
                <span
                  className="w-full md:w-auto relative px-5 py-2.5 transition-all ease-in duration-75 
                bg-amber-100 dark:bg-gray-900 rounded-md group-hover:bg-opacity-0"
                >
                  Download
                </span>
              </button>
          ...
          <section
            id="contacts"
            className="flex flex-col items-center justify-evenly w-full mt-32"
          >
            <p className="text-2xl text-gray-400">Reach out here</p>
            <div className="flex items-center justify-evenly w-full my-12 flex-wrap gap-4">
              {SocialLinks &&
                SocialLinks.map((n) => (
                  <motion.a
                    whileTap={{ scale: 0.8 }}
